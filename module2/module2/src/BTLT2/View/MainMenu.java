...
import BTLT2.models.*;
import BTLT2.Service.*;
import BTLT2.util.ConstantUtil;
import BTLT2.util.ReadAndWriteFile2;
...
import java.util.Scanner;
    ...
    public class MainMenu {
        ...
        private static ReadAndWriteFile2 readAndWriteFile2 = new ReadAndWriteFile2();
        ...
        private static void add() {
            ...
            switch (choice) {
                case 1 : {
                    ...
                    readAndWriteFile2.writeFile("src/BTLT2/data/trucks.csv",trucks,true);
                    break;
                }
                case 2 : {
